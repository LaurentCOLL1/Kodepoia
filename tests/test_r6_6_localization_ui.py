...
def test_kodestudio_pseudo_locale_expands_registered_main_surface_without_nav_truncation() -> None:
    ...
    try:
        ...
        # V2.3.4 adds governed Training, and V2.3.5 adds Candidate lifecycle.
        assert len(texts) == 19
        ...
        candidate_refresh = window.findChild(QPushButton, "modelLabCandidateRefresh")
        ...
        assert candidate_refresh is not None and candidate_refresh.text().startswith("⟦")
