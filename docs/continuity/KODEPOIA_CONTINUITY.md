...
- R16.8 : **IN_PROGRESS** — normalized R16.7 `main` `951c53959956d1b88b3c9c3a8c4c328c1127236b`; dedicated branch `r16/08-fault-injection-recovery`; scope frozen to deterministic fault injection, KillSwitch, backup integrity and recovery-before-continuation drills; manual NONE. R16.9 remains PLANNED.
