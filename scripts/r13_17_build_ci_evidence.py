...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build exact-head R13.17 CI evidence after independent gates pass.")
    ...
    parser.add_argument("--output", default="docs/roadmap/R13_17_CI_ACCEPTANCE.json")
