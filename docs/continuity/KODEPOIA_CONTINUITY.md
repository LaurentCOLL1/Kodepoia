...
- R16.4 : **IN_PROGRESS** — normalized R16.3 `main` `cb6ec02629fd94f9d23b04ebfed525571c8482d9`; dedicated branch `r16/04-secrets-privacy-exfiltration-hardening`; START sync is documentation-only and precedes any technical implementation. Scope: synthetic secret classes/canaries, narrow secret resolution, taint/redaction across argv/env/stdin/stdout/stderr/logs/reports/artifacts, exfiltration destination control, useful redacted failure diagnostics, artifact leak scanning, and rotation/revocation-safe credential references. Manual NONE; no live credential is authorized for acceptance.
