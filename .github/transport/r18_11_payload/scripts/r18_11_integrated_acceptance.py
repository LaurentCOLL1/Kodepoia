...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="R18.11 integrated release/update acceptance")
    parser.add_argument("--root", type=Path, default=Path.cwd())
    subparsers = parser.add_subparsers(dest="command", required=True)

    core = subparsers.add_parser("core", help="emit exact-source R18.1-R18.10 core evidence")
    ...
    finalize = subparsers.add_parser("finalize", help="combine core and Windows RC evidence")
