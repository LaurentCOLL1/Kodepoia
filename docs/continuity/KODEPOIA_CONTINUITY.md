> Kodepoia, architecture v1.0 gelée. **R1–R14 COMPLETE + NORMALIZED. R15 planning ACCEPTED + NORMALIZED. R15.1–R15.16 COMPLETE + NORMALIZED; R15.17 IN_PROGRESS.** R15.16 final END-head `407a174e152f6869ad44e7de8377edfd4e256f7e` passed R15.16 #3 / `33337805981`, R0 #2220 / `33337805967`, Python Core #2195 / `33337805923` 5/5 and UI #2160 / `33337806063`; implementation PR #328 merged as `d4db71ed14ddd15852795e5b1d3e174ca038cce7`. Unique normalization head `f8b83089df9d89c5ca69a15f340190863108445a` passed R0 #2222 / `33338144362`, Python Core #2197 / `33338144262` 5/5 and UI #2162 / `33338144365`, then PR #329 merged with exact expected-head protection as normalized `main` `eb7ba3e01af9d96e0a49abfb20424e83261c2b14`. R15.17 starts only from that exact main on `r15/17-adversarial-integrated-acceptance`; manual state starts CONDITIONAL / NOT TRIGGERED because R15.16 required no real target-workstation promotion evidence.
...
| R15.17 | IN_PROGRESS | CONDITIONAL / NOT TRIGGERED |
...
- R15.17 : **IN_PROGRESS** — authorized branch point is normalized R15.16 `main` `eb7ba3e01af9d96e0a49abfb20424e83261c2b14`; dedicated branch `r15/17-adversarial-integrated-acceptance`. Core integrated acceptance must prove the frozen 14 adversarial invariants without circular checked-in PASS evidence, generate the canonical R15 integrated report from the exact source, and keep missing optional real GPU/llama.cpp/Ollama capability truthful rather than synthetic. R15.16 manual state did not trigger a real local evidence dependency, so R15.17 manual state starts `CONDITIONAL / NOT TRIGGERED`.

## Next authorized action

**R15.17 only: implement the repository-owned adversarial integrated Experience/Bench/Fine-tuning scenario on `r15/17-adversarial-integrated-acceptance` from exact normalized `main` `eb7ba3e01af9d96e0a49abfb20424e83261c2b14`. Generate/validate the canonical integrated report from scenario execution, not from a pre-existing PASS field; require dedicated R15 integrated acceptance + R0 + full Python Core + KodeStudio UI Smoke on the exact source/END heads. R16 planning remains unauthorized until R15.17 merges and the unique post-merge R15 phase continuity-only normalization passes fresh R0/Python/UI and merges. Manual state: CONDITIONAL / NOT TRIGGERED.**
