...
def test_r16_9_policy_is_integrity_bound_and_provenance_only() -> None:
    ...
    assert len(policy.immutable_authority_workflows) == 45
    assert (
    ...
    r18_9_workflow = ".github/workflows/r18-9-winget-acceptance.yml"
    assert r18_9_workflow in policy.immutable_authority_workflows
    r18_10_workflow = ".github/workflows/r18-10-incident-drills-acceptance.yml"
    assert r18_10_workflow in policy.immutable_authority_workflows
    r18_11_workflow = ".github/workflows/r18-11-integrated-acceptance.yml"
    assert r18_11_workflow in policy.immutable_authority_workflows
    r19_2_workflow = ".github/workflows/r19-2-update-repository-bootstrap-acceptance.yml"
    ...
    r19_5_workflow = ".github/workflows/r19-5-corrective-rc-acceptance.yml"
    assert r19_5_workflow in policy.immutable_authority_workflows
    r20_1_workflow = ".github/workflows/r20-1-bridge-metadata-refresh-acceptance.yml"
    ...
    r20_5_monitor_workflow = ".github/workflows/r20-5-expiry-monitoring.yml"
    assert r20_5_monitor_workflow in policy.immutable_authority_workflows
    r20_5_acceptance_workflow = (
        ".github/workflows/r20-5-expiry-monitoring-acceptance.yml"
    )
    assert r20_5_acceptance_workflow in policy.immutable_authority_workflows
