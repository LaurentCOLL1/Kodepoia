...
# Root installer must be a Git LFS object, not a normal large Git blob.
...
# R0 must explicitly permit and require the root installer mirror.
...
# Make installation obvious from the repository landing page.
