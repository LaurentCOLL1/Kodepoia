...
from kodepoia.mobile.integrated_acceptance import build_repository_report, validate_repository_evidence
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the canonical anti-circular R13 integrated acceptance report.")
    parser.add_argument("--source-sha", required=True, help="Immutable accepted R13.17 implementation source SHA")
    parser.add_argument("--repository-root", default=".")
    parser.add_argument("--output", default="docs/roadmap/R13_INTEGRATED_ACCEPTANCE.json")
