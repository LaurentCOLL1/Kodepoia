...
Post-merge completion: final exact-END `2cad928d86af244a32313587348a4cb989b1ca71` passed R18.4 `33971108687`, R16.9 `33971108772`, R0 Repository Guard `33971108746`, full Python Core `33971108760` and KodeStudio UI Smoke `33971108733`, all SUCCESS. PR #389 merged that exact head with expected-head protection as implementation/evidence `main` `8b5e09622399d24f87c20a3820e38111d3072b6e`. Unique normalization head `08bb3e39c72a10da995e1a3d3686bcf5bfef02cf` changed only `docs/continuity/KODEPOIA_CONTINUITY.md`, passed fresh R0 Repository Guard #2468 / `33971951487`, full Python Core #2440 / `33971951488` and KodeStudio UI Smoke #2405 / `33971951518`, then PR #390 merged that exact head as canonical normalized `main` `b6aa853c59921bf51e346b7860e709cca63a4a2e`. R18.4 is therefore COMPLETE + NORMALIZED; no second R18.4 normalization is authorized.
...
END-sync technical acceptance: normalized R18.4 base `main` `b6aa853c59921bf51e346b7860e709cca63a4a2e`; dedicated branch `r18/05-immutable-github-release-staging`; immutable technical source `bc863b1fedf5cbee03d319f250a34d75c88007ed`. Dedicated R18.5 #12 / `33978376317` is SUCCESS on Ubuntu + Windows with compile, Ruff, 12/12 focused tests and synthetic/offline staging acceptance. Intended tag is `v1.1.0-rc1`; exact staged-release digest is `de3f79c727a519a508ab2b05a1a2ca5cd254112e2e8b962b07d1c2ba3875746b`. Negative controls reject source mismatch, missing R18.3 evidence, contradictory signing state, missing attestation verification, unexpected assets, mutable tag reuse, wrong-digest approval and staged-record tamper. Acceptance records `github_api_write_calls=0`, `public_release_created=false`, `immutable_release_setting_changed=false`, `production_signed=false`, `public_trust_claim=false`, `security_claim=false` and `manual_state=CONDITIONAL_NOT_TRIGGERED`. Technical artifacts are Linux ID `9972996623` / `r18-5-release-staging-Linux-bc863b1fedf5cbee03d319f250a34d75c88007ed`, artifact ZIP digest `sha256:31ea6b88b9898e59dc683020024fb137b124e55e904db326fd8a7ae3faad9e30`, and Windows ID `9973002955` / `r18-5-release-staging-Windows-bc863b1fedf5cbee03d319f250a34d75c88007ed`, artifact ZIP digest `sha256:545f77b6d27e9898eb2db11c6786a1d9b727127c352734e19d65e278166c40ef`. Same-source gates are SUCCESS: R0 Repository Guard #2474 / `33978376220`; full Python Core #2446 / `33978376302` 5/5 with Ubuntu `2209 passed / 18 skipped / 47 warnings`; KodeStudio UI Smoke #2411 / `33978376239`; R16.9 #134 / `33978376252`; R18.3 #28 / `33978376217`. Public GitHub Release creation, repository immutable-release setting changes, production signing and public WinGet submission remain CONDITIONAL / NOT TRIGGERED. Because this END-sync changes documentation bytes, fresh R18.5 + R18.3 + R16.9 + R0 + full Python Core + KodeStudio UI Smoke gates on the resulting exact END-head are mandatory before PR #391 may merge with `expected_head_sha`; exactly one post-merge continuity-only R18.5 normalization must then pass fresh R0/Python/UI before R18.6 START is authorized.

Post-merge completion: final exact-END `c7cc79eef2f36ff82282c5a86492b86cd153e598` passed fresh R18.5 #14 / `33982737425`, R18.3 #29 / `33982737479`, R16.9 #135 / `33982737432`, R0 #2475 / `33982737478`, full Python Core #2447 / `33982737488` and KodeStudio UI Smoke #2412 / `33982737457`; PR #391 merged that exact head with `expected_head_sha=c7cc79eef2f36ff82282c5a86492b86cd153e598` as implementation/evidence `main` `32ef447a390733ee9d31e36df7a63a0954aba3bc`. Unique post-merge continuity-only normalization head `2873f1f71423a7bcc18b9baded71a2b9dda0b4b7` passed fresh R0 Repository Guard #2477 / `33986857295`, full Python Core #2449 / `33986857492` 5/5 and KodeStudio UI Smoke #2414 / `33986857407`, then PR #392 merged that exact head as canonical normalized `main` `2f0929c30f717ad608523cc1837ecfb1129a28f1`. R18.5 is therefore COMPLETE + NORMALIZED; no second R18.5 normalization is authorized.
...
END-sync technical acceptance: normalized R18.5 base `main` `2f0929c30f717ad608523cc1837ecfb1129a28f1`; dedicated branch `r18/06-tuf-rollback-freeze-verification`; immutable technical source `071d5a8715d0d28c73283a9313730a339d72cc44`. Dedicated R18.6 #46 / `33991430903` is SUCCESS on Ubuntu + Windows with exact checkout provenance, compile, Ruff, 18 focused tests, wheel build, verification that the packaged root resources survive the wheel, fresh synthetic-root evidence, 7/7 core TUF cases, 7/7 product-update cases and no public effects. The embedded synthetic root is version 1 with a 2-of-2 root threshold, exactly 2044 bytes and SHA-256 `885bc87c3a5e9fe8b378cac85eb89fc37f99fcd8ba0bc7c494ee1e407da96670`; it is acceptance-only, requires explicit synthetic opt-in, persists no private keys and makes no production trust claim. Technical Actions artifacts are Linux ID `9976809112` / `r18-6-tuf-Linux-071d5a8715d0d28c73283a9313730a339d72cc44`, ZIP digest `sha256:bc5bb6a7c0882e922773b710ae28871e5482a60e9fcbb363734468f8376d9467`, and Windows ID `9976769232` / `r18-6-tuf-Windows-071d5a8715d0d28c73283a9313730a339d72cc44`, ZIP digest `sha256:e2cd87e6e949072240f8160d102bb0028a0cc1780d8e24b166df2098a896610c`. Same-source gates are SUCCESS: R0 Repository Guard #2498 / `33991430795` Ubuntu + Windows; full Python Core #2470 / `33991430942` 5/5; KodeStudio UI Smoke #2435 / `33991430896`; R16.9 Supply Chain Provenance #156 / `33991430781` Ubuntu + Windows. Manual intervention is NONE. Production TUF key custody/hosting, production signing, public GitHub Release publication, immutable-release repository setting changes and public WinGet submission remain NOT TRIGGERED. Because this END-sync changes documentation bytes, fresh R18.6 + R16.9 + R0 + full Python Core + KodeStudio UI Smoke gates on the resulting exact END-head are mandatory before PR #393 may merge with `expected_head_sha`; exactly one post-merge continuity-only R18.6 normalization must then pass fresh R0/Python/UI before R18.7 START is authorized.
...
END-sync technical acceptance: normalized R18.7 base `main` `03ad2cbede77fbf29d996ad21ad65e74ae09273a`; dedicated branch `r18/08-verified-download-install-rollback`; immutable accepted technical source `9b007c4acd113fcf6b5863e8cc7188de45751243`. Dedicated R18.8 #16 / `34021987833` is SUCCESS on Ubuntu + Windows with exact checkout provenance, compile, Ruff, 10/10 focused verified-delivery tests, 24/24 R16.9 supply-chain regressions and 3/3 Qt tests. Acceptance proves bounded streaming to `.partial`, atomic finalize only after TUF length/hash + release-identity + R18.4 Authenticode-policy verification, pre-launch tamper recheck, explicit user consent, no automatic installer launch, recovery metadata persistence, cancellation/interruption cleanup and no project-data mutation. Technical artifacts are Linux ID `9985805699` / `r18-8-verified-install-Linux-9b007c4acd113fcf6b5863e8cc7188de45751243`, ZIP digest `sha256:1b5788016c87c65577a5e3ac9a230ea2dfc887fe7b3422c49a555de1ea4eac5a`, and Windows ID `9985811971` / `r18-8-verified-install-Windows-9b007c4acd113fcf6b5863e8cc7188de45751243`, ZIP digest `sha256:43f6006b46e35bee964efe22fd612bbbaa989d6a9fab2bbc6b2f74b2f3ad6bd8`. Same-source gates are SUCCESS: R16.9 Supply Chain Provenance #190 / `34021988000` Ubuntu + Windows; R0 Repository Guard #2536 / `34021988066` Ubuntu + Windows; full Python Core #2508 / `34021988147` 5/5; KodeStudio UI Smoke #2473 / `34021988151` Windows. Same-source R17 Windows Installer #114 / `34021987980` is SUCCESS: 11 focused R17 tests, exact-source Nuitka/Inno build, `KodepoiaSetup.exe` version `1.1.0-rc1`, SHA-256 `db2ea7809c41612bab73251b7eb656b877190045a2f6daa80c04761db750ec40`, `production_signed=false`, clean silent install, packaged UI smoke without developer Python/pip and silent uninstall. Installer Actions artifact ID `9986235047`, `KodepoiaSetup-Windows`, 36,600,332 bytes, ZIP digest `sha256:ca3afa0d7c99e4a5c84501a49c61f8aeff26d366d598becfa0ed285f2e01bddc`. Manual intervention is NONE. Production signing, public GitHub Release publication, immutable-release repository setting changes, production TUF key custody/hosting and public WinGet submission remain CONDITIONAL / NOT TRIGGERED. Because this END-sync changes documentation bytes, fresh R18.8 + R16.9 + R0 + full Python Core + KodeStudio UI Smoke + R17 Windows installer regression on the resulting exact END-head are mandatory before PR #397 may merge with `expected_head_sha`; exactly one post-merge continuity-only R18.8 normalization must then pass fresh R0/Python/UI before R18.9 START is authorized.
...
## R18.9 END-sync authority

- Immutable accepted technical source: `50918a9c7a6b15cc166f0d0397d68ab935bf538a` on `r18/09-winget-manifest-generation-validation`.
- Dedicated R18.9 WinGet Manifest Generation Validation Acceptance #10 / `34043185432` is **SUCCESS** on that exact SHA. Exact checkout provenance, compile/Ruff, 44 focused WinGet + R16.9 supply-chain tests, Inno Setup installation, exact-source Nuitka/Inno installer build, governed preview manifest generation and evidence upload all succeeded.
- Exact technical evidence artifact: ID `9992690521`, `r18-9-winget-50918a9c7a6b15cc166f0d0397d68ab935bf538a`, 3,724 bytes, ZIP digest `sha256:5b32e4856d209a68b370e6294acabb44e9e9c497712eb31fa50790f053676f7b`.
- Acceptance report is 20/20 PASS. Exact installer `KodepoiaSetup.exe`: 37,152,584 bytes, SHA-256 `d32d079ba75ddc0ce9271a76ad20f5a5571e3abf909b445c747c291185ea5877`, version `1.1.0-rc1`, beta prerelease, `production_signed=false`.
- Generated four-file WinGet preview bundle uses `ManifestVersion: 1.12.0`, `InstallerType: inno`, `Architecture: x64`, user scope, exact installer SHA-256, `fr-FR` default locale + `en-US` locale and bundle SHA-256 `69d3330bc26b9d60c3bccae243ff751355d28e6c12e50179d513a1e0d8035f7e`.
- Ordinary CI preview is deliberately non-publishable: `InstallerUrl` uses `preview.invalid`; official `winget validate` is recorded as `SKIPPED_NON_PUBLISHABLE_PREVIEW` with null return code because the public-submission validator requires a real publishable InstallerUrl. The publishable path remains fail-closed and must execute the official validator when a verified immutable public release URL exists.
- Publication blockers remain `public_release_not_verified`, `immutable_release_not_verified`, `production_signing_not_verified`; `network_publication_calls=0`, `public_submission_authorized=false`, `public_submission_performed=false`. Manual state remains **CONDITIONAL / NOT TRIGGERED**.
- Rejected candidates/runs remain non-authoritative: `c9588d4f…` failed Ruff before acceptance; `ca6a713d…` / R18.9 #5 diagnosed the invalid attempt to run the public-submission validator against a `.invalid` preview. No evidence from those candidates is reused as final acceptance authority.
- Because this END-sync changes documentation bytes, the resulting exact END head must pass fresh R18.9 acceptance, R16.9 Supply Chain Provenance, R0 Repository Guard Ubuntu + Windows, full Python Core 5/5 and KodeStudio UI Smoke before the implementation/evidence PR may merge with exact expected-head protection. Exactly one post-merge continuity-only R18.9 normalization must then be re-gated before R18.10 START-sync is authorized.


## R18.10 START-sync authority

- Exact normalized branch point: `main` `a285a5d995abca6915a18d0c6d2b188bedd3e017`, produced by the single R18.9 post-merge normalization PR #400 after exact candidate `b5ad703a7aefebbb52954d11ac73c1fb4e25982d` passed fresh R0 Repository Guard #2543 / `34046859016` Ubuntu + Windows, full Python Core #2515 / `34046858980` 5/5 and KodeStudio UI Smoke #2480 / `34046859156` Windows.
- Dedicated branch: `r18/10-revocation-rollback-compromised-release-drills`, created directly from that exact normalized `main` before any R18.10 implementation byte.
- State transition: R18.1–R18.9 **COMPLETE + NORMALIZED**; R18.10 **IN_PROGRESS**; R18.11 **PLANNED**.
- Frozen scope remains the planned synthetic incident/recovery surface: compromised signing-certificate evidence and trust-policy denial; TUF Root/key rotation plus rollback/freeze drills; release withdrawal/supersession and UI state; malicious/wrong release-asset rejection; rollback to last-known-good installer/channel state; and an incident playbook that distinguishes local simulation from provider-side production actions.
- Implementation must extend the already accepted R18.4/R18.5/R18.6/R18.7/R18.8 trust primitives rather than create a parallel trust stack: `kodepoia.release.signing`, `kodepoia.release.promotion`, TUF verification/update trust, discovery and verified delivery/recovery remain authoritative boundaries.
- Official research rechecked on 2026-09-06: TUF requires Root/Targets/Snapshot/Timestamp roles with expiry and signature thresholds; compromised top-level role keys are replaced through Root, while compromise of a Root threshold requires out-of-band Root re-issuance. Microsoft SignTool `verify` checks whether the signing certificate is trusted and revoked. GitHub immutable releases lock published assets and the associated tag and automatically produce release attestations; artifact attestations have an explicit lifecycle and may be removed when consumers should no longer trust the associated artifact.
- Core drill execution is **synthetic, deterministic and non-destructive**. No real certificate revocation, production signing-key rotation, public release/tag/asset deletion, immutable-release setting mutation, attestation deletion, WinGet submission or other provider-side production effect is authorized by this START. Network publication/effect calls must remain zero in authoritative CI fixtures.
- Minimum scenario families are fail-closed certificate compromise; accepted sequential TUF Root rotation; rejected Root/Timestamp/Snapshot/Targets rollback or freeze; withdrawn/superseded release rejection; tampered/wrong asset rejection; last-known-good recovery with normal application work preserved; and explicit provider-side action records marked `NOT_EXECUTED`.
- Required R18.10 evidence will be a structured deterministic drill report binding exact source SHA, scenario IDs, expected/actual verdicts, non-secret key/metadata versions, recovery result, critical-bypass count and provider-effect count. Any unexpected acceptance of a critical attack blocks completion.
- Manual intervention: **NONE** for the authoritative synthetic drills. Production/provider-side incident actions remain conditional and are deliberately outside R18.10 core acceptance unless separately authorized because of a real incident.
- This START-sync is documentation-only. No incident module, fixture, workflow, test, playbook or other R18.10 implementation byte may precede the clean START decision head; temporary transport helpers are non-authoritative and must be absent from its clean tree and lineage.
