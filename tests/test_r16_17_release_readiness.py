...
def test_r16_17_release_baseline_remains_frozen_while_current_identity_advances() -> None:
    # R16.17 is historical evidence for the v1.0 RC baseline. Later release
    # phases must not rewrite that history, while the repository's current
    # release identity may advance independently under its newer authority.
