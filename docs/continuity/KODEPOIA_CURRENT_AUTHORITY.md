...
**Current development direction:** Roadmap V2; V2.1, V2.2 and V2.3 are COMPLETE + NORMALIZED. V2.4 planning and V2.4.1 are COMPLETE + NORMALIZED. **V2.4.2 is COMPLETE + NORMALIZED.** V2.4.2 implementation PR `#520` was qualified **29/29** on exact final head `abf9d396ef4f2800c5e9de9bd62a9b680a2be758`, with deterministic V2.4.2 acceptance **23/23 PASS on Ubuntu and 23/23 PASS on Windows**, common evidence SHA-256 `f10a620c34ea3928ce6de4e44002485120654c031d6073bbf00f5f3bddf68ffa`, then merged with `expected_head_sha` protection as `4d411df6b0923b1443017ff25f06b1c04453a7f6`. **V2.4.3 — Governed explicit two-GPU execution is the only authorized implementation subdivision.** V2.4.4+ remain unauthorized until V2.4.3 is implemented, exact-head qualified, merged and post-merge normalized.
...
V2.3 is **COMPLETE + NORMALIZED** through V2.3.6. V2.4 planning, V2.4.1 and **V2.4.2 are COMPLETE + NORMALIZED**. V2.4.1 remains accepted from PR `#518`, exact head `544b7d172499594f32c464c46753bfc5fb378fe0`, merge `3ebed48b8aa113635ddc9516827d867ce346fe0f`. V2.4.2 implementation PR `#520` was qualified **29/29** on exact final head `abf9d396ef4f2800c5e9de9bd62a9b680a2be758`; deterministic acceptance passed **23/23 on Ubuntu** and **23/23 on Windows** with common evidence SHA-256 `f10a620c34ea3928ce6de4e44002485120654c031d6073bbf00f5f3bddf68ffa`, Ubuntu artifact `10620663114` and Windows artifact `10620827996`. It merged with `expected_head_sha` protection as `4d411df6b0923b1443017ff25f06b1c04453a7f6`. Accepted V2.4.2 truth binds the immutable R15.9 TrainingPlan digest and V2.4.1 topology evidence to typed `single_gpu` / `replicated_data_parallel` strategy plans; binds exact world size, selected ordinals, independent per-device VRAM budgets, host RAM/storage, batch/accumulation/effective global batch and deterministic rank/data seeds; requires paired benchmark evidence with repository threshold **>=1.25x throughput** and **zero allowed eval-loss regression**; and hard-codes `launch_authorized=false`. No distributed worker launch, pooled VRAM, torchrun/Accelerate two-rank execution, sharded-memory strategy or TPU path was introduced. **This normalization authorizes V2.4.3 — Governed explicit two-GPU execution only.** V2.4.4+ remain unauthorized until V2.4.3 is implemented, exact-head qualified, merged and post-merge normalized. V2.5+, release/TUF/updater mutation and R20 reopening remain unauthorized.
...
5. `docs/roadmap/V2_4_KAGGLE_T4X2_PRODUCTION_MULTIGPU.md` for normalized V2.4 planning/V2.4.1/V2.4.2 authority and the current V2.4.3 boundary;
