...
**Execution checkpoint:** R13.1–R13.12 are `COMPLETE + NORMALIZED`. R13.13 is `IN_PROGRESS` on dedicated branch `r13/13-koderelease`, created exactly from normalized `main` `bad4790bbc6a34c42bbc86d45db013722a25fdae`. R13.14–R13.17 remain `PLANNED`.
...
R13 planning is **ACCEPTED + NORMALIZED** on `main` `aef297e385dc49ad6ae0935d4f9ef25a35e5e984`; R13.1–R13.12 are **COMPLETE + NORMALIZED**; R13.13 is **IN_PROGRESS**; R13.14–R13.17 remain **PLANNED / NOT STARTED**.
...
| R13.13 | KodeRelease versioning, release trains, promotion, rollout + rollback | IN_PROGRESS | NONE | R13.4–R13.12 + R8/R12 |
