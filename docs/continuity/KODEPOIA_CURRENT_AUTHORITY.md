...
**Current development direction:** Roadmap V2; V2.1, V2.2 and V2.3 are COMPLETE + NORMALIZED. V2.4 planning, V2.4.1 and V2.4.2 are COMPLETE + NORMALIZED. **V2.4.3 is COMPLETE + NORMALIZED.** V2.4.3 implementation PR `#522` was qualified **30/30** on exact final head `81c5709ff457da375fd2f8f8ef13aad4b59aced0`, with deterministic V2.4.3 acceptance **22/22 PASS on Ubuntu and 22/22 PASS on Windows**, common evidence SHA-256 `fbcad387a86924c1ed7384b4408e2910c63c550f6dd9283e7c020b03b8ffbbc7`, then merged with `expected_head_sha` protection as `975d46a071f52a27a48de15227432d9d4911e142`. **V2.4.4 — Distributed checkpoint, cancellation and recovery is the only authorized implementation subdivision.** V2.4.5+ remain unauthorized until V2.4.4 is implemented, exact-head qualified, merged and post-merge normalized.
...
V2.3 is **COMPLETE + NORMALIZED** through V2.3.6. V2.4 planning, V2.4.1, V2.4.2 and **V2.4.3 are COMPLETE + NORMALIZED**. V2.4.2 remains accepted from PR `#520`, exact head `abf9d396ef4f2800c5e9de9bd62a9b680a2be758`, merge `4d411df6b0923b1443017ff25f06b1c04453a7f6`. V2.4.3 implementation PR `#522` was qualified **30/30** on exact final head `81c5709ff457da375fd2f8f8ef13aad4b59aced0`; deterministic acceptance passed **22/22 on Ubuntu** and **22/22 on Windows** with common evidence SHA-256 `fbcad387a86924c1ed7384b4408e2910c63c550f6dd9283e7c020b03b8ffbbc7`, Ubuntu artifact `10646496287` and Windows artifact `10646575915`. It merged with `expected_head_sha` protection as `975d46a071f52a27a48de15227432d9d4911e142`. Accepted V2.4.3 truth requires exact qualified V2.4.2 benchmark/strategy lineage, fixes launch to one node/two ranks through repository-owned `torch.distributed.run`, injects only accepted device visibility, derives trusted rank/local-rank/world-size from launcher state, preserves deterministic rank/data/sampler seeds, makes rank zero the sole canonical output authority, records integrity-bound per-rank evidence, treats any rank failure/timeout/cancellation/missing evidence as whole-run terminal, and extends ProcessSandbox/KillSwitch to the complete managed process group. Distributed resume remains explicitly unauthorized in V2.4.3; no pooled VRAM, FSDP, DeepSpeed/ZeRO, tensor/pipeline parallelism or TPU path was introduced. R13 Android Signing Windows required one same-SHA failed-job rerun during qualification; Ubuntu remained successful, no code/workflow/criterion changed, and the rerun completed successfully. **This normalization authorizes V2.4.4 — Distributed checkpoint, cancellation and recovery only.** V2.4.5+ remain unauthorized until V2.4.4 is implemented, exact-head qualified, merged and post-merge normalized. V2.5+, release/TUF/updater mutation and R20 reopening remain unauthorized.
...
5. `docs/roadmap/V2_4_KAGGLE_T4X2_PRODUCTION_MULTIGPU.md` for normalized V2.4 planning/V2.4.1/V2.4.2/V2.4.3 authority and the current V2.4.4 boundary;
